 ...
 * PLACE ANY CUSTOMIZATIONS IN tog_Company
 */

require_once('include/SugarObjects/templates/company/Company.php');

class tog_Company_sugar extends Company {
	var $new_schema = true;
	var $module_dir = 'tog_Company';
	var $object_name = 'tog_Company';
	var $table_name = 'tog_company';
	var $importable = true;
