<?php /* Smarty version 2.6.11, created on 2016-05-20 05:17:48
         compiled from cache/modules/tog_Company/DetailView.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_include', 'cache/modules/tog_Company/DetailView.tpl', 33, false),array('function', 'counter', 'cache/modules/tog_Company/DetailView.tpl', 38, false),array('function', 'sugar_translate', 'cache/modules/tog_Company/DetailView.tpl', 47, false),array('function', 'sugar_phone', 'cache/modules/tog_Company/DetailView.tpl', 76, false),array('function', 'sugar_ajax_url', 'cache/modules/tog_Company/DetailView.tpl', 496, false),array('modifier', 'strip_semicolon', 'cache/modules/tog_Company/DetailView.tpl', 48, false),array('modifier', 'substr', 'cache/modules/tog_Company/DetailView.tpl', 102, false),array('modifier', 'to_url', 'cache/modules/tog_Company/DetailView.tpl', 104, false),array('modifier', 'escape', 'cache/modules/tog_Company/DetailView.tpl', 456, false),array('modifier', 'url2html', 'cache/modules/tog_Company/DetailView.tpl', 456, false),array('modifier', 'nl2br', 'cache/modules/tog_Company/DetailView.tpl', 456, false),)), $this); ?>
...
" class="button primary" onclick="var _form = document.getElementById('formDetailView'); _form.return_module.value='tog_Company'; _form.return_action.value='DetailView'; _form.return_id.value='<?php echo $this->_tpl_vars['id']; ?>
...
" class="button" onclick="var _form = document.getElementById('formDetailView'); _form.return_module.value='tog_Company'; _form.return_action.value='DetailView'; _form.isDuplicate.value=true; _form.action.value='EditView'; _form.return_id.value='<?php echo $this->_tpl_vars['id']; ?>
...
" class="button" onclick="var _form = document.getElementById('formDetailView'); _form.return_module.value='tog_Company'; _form.return_action.value='ListView'; _form.action.value='Delete'; if(confirm('<?php echo $this->_tpl_vars['APP']['NTC_DELETE_CONFIRMATION']; ?>
...
" class="button" onclick="var _form = document.getElementById('formDetailView'); _form.return_module.value='tog_Company'; _form.return_action.value='DetailView'; _form.return_id.value='<?php echo $this->_tpl_vars['id']; ?>
...
<td width='12.5%' scope="col">
<?php if (! $this->_tpl_vars['fields']['phone_alternate']['hidden']):  ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_PHONE_ALT','module' => 'tog_Company'), $this); $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean();  echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
<?php endif; ?>
</td>
<td width='37.5%'  class="phone">
<?php if (! $this->_tpl_vars['fields']['phone_alternate']['hidden']):  echo smarty_function_counter(array('name' => 'panelFieldCount'), $this);?>


<?php if (! empty ( $this->_tpl_vars['fields']['phone_alternate']['value'] )):  $this->assign('phone_value', $this->_tpl_vars['fields']['phone_alternate']['value']);  echo smarty_function_sugar_phone(array('value' => $this->_tpl_vars['phone_value'],'usa_format' => '0'), $this);?>
...
<td width='12.5%' scope="col">
<?php if (! $this->_tpl_vars['fields']['tog_company_type']['hidden']):  ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_TYPE','module' => 'tog_Company'), $this); $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean();  echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
<?php endif; ?>
</td>
<td width='37.5%'  >
<?php if (! $this->_tpl_vars['fields']['tog_company_type']['hidden']):  echo smarty_function_counter(array('name' => 'panelFieldCount'), $this);?>



<?php if (is_string ( $this->_tpl_vars['fields']['tog_company_type']['options'] )): ?>
<input type="hidden" class="sugar_field" id="<?php echo $this->_tpl_vars['fields']['tog_company_type']['name']; ?>
" value="<?php echo $this->_tpl_vars['fields']['tog_company_type']['options']; ?>
">
<?php echo $this->_tpl_vars['fields']['tog_company_type']['options']; ?>

<?php else: ?>
<input type="hidden" class="sugar_field" id="<?php echo $this->_tpl_vars['fields']['tog_company_type']['name']; ?>
" value="<?php echo $this->_tpl_vars['fields']['tog_company_type']['value']; ?>
">
<?php echo $this->_tpl_vars['fields']['tog_company_type']['options'][$this->_tpl_vars['fields']['tog_company_type']['value']]; ?>
...
<?php $this->assign('value', "05/20/2016"); ?>
...
<td width='12.5%' scope="col">
<?php if (! $this->_tpl_vars['fields']['date_entered']['hidden']):  ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_DATE_ENTERED','module' => 'tog_Company'), $this); $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean();  echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
<?php endif; ?>
</td>
<td width='37.5%'  >
...
<td width='12.5%' scope="col">
<?php if (! $this->_tpl_vars['fields']['billing_address_street']['hidden']):  ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_BILLING_ADDRESS_STREET','module' => 'tog_Company'), $this); $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean();  echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
<?php endif; ?>
</td>
<td width='37.5%'  >
...
<td width='12.5%' scope="col">
<?php if (! $this->_tpl_vars['fields']['shipping_address_street']['hidden']):  ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_SHIPPING_ADDRESS_STREET','module' => 'tog_Company'), $this); $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean();  echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
<?php endif; ?>
</td>
<td width='37.5%'  >
...
<td width='12.5%' scope="col">
<?php if (! $this->_tpl_vars['fields']['tog_testmodule_tog_company_name']['hidden']):  ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_TOG_TESTMODULE_TOG_COMPANY_FROM_TOG_TESTMODULE_TITLE','module' => 'tog_Company'), $this); $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean();  echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
<?php endif; ?>
</td>
<td width='37.5%'  >
<?php if (! $this->_tpl_vars['fields']['tog_testmodule_tog_company_name']['hidden']):  echo smarty_function_counter(array('name' => 'panelFieldCount'), $this);?>


<?php if (! empty ( $this->_tpl_vars['fields']['tog_testmodule_tog_companytog_testmodule_ida']['value'] )):  ob_start(); ?>index.php?module=tog_testmodule&action=DetailView&record=<?php echo $this->_tpl_vars['fields']['tog_testmodule_tog_companytog_testmodule_ida']['value'];  $this->_smarty_vars['capture']['default'] = ob_get_contents();  $this->assign('detail_url', ob_get_contents());ob_end_clean(); ?>
<a href="<?php echo smarty_function_sugar_ajax_url(array('url' => $this->_tpl_vars['detail_url']), $this);?>
"><?php endif; ?>
<span id="tog_testmodule_tog_companytog_testmodule_ida" class="sugar_field" data-id-value="<?php echo $this->_tpl_vars['fields']['tog_testmodule_tog_companytog_testmodule_ida']['value']; ?>
"><?php echo $this->_tpl_vars['fields']['tog_testmodule_tog_company_name']['value']; ?>
</span>
<?php if (! empty ( $this->_tpl_vars['fields']['tog_testmodule_tog_companytog_testmodule_ida']['value'] )): ?></a><?php endif;  endif; ?>
</td>
</tr>
<?php $this->_smarty_vars['capture']['tr'] = ob_get_contents();  $this->assign('tableRow', ob_get_contents());ob_end_clean();  if ($this->_tpl_vars['fieldsUsed'] > 0 && $this->_tpl_vars['fieldsUsed'] != $this->_tpl_vars['fieldsHidden']):  echo $this->_tpl_vars['tableRow']; ?>
