...
<td valign="top" id='tog_company_contacts_name_label' width='12.5%' scope="col">
<?php ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_TOG_COMPANY_CONTACTS_FROM_TOG_COMPANY_TITLE','module' => 'Contacts'), $this); $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean();  echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
</td>
<?php echo smarty_function_counter(array('name' => 'fieldsUsed'), $this);?>
...
<input type="text" name="<?php echo $this->_tpl_vars['fields']['tog_company_contacts_name']['name']; ?>
" class="sqsEnabled" tabindex="0" id="<?php echo $this->_tpl_vars['fields']['tog_company_contacts_name']['name']; ?>
" size="" value="<?php echo $this->_tpl_vars['fields']['tog_company_contacts_name']['value']; ?>
" title='' autocomplete="off"  	 >
<input type="hidden" name="<?php echo $this->_tpl_vars['fields']['tog_company_contacts_name']['id_name']; ?>
" 
id="<?php echo $this->_tpl_vars['fields']['tog_company_contacts_name']['id_name']; ?>
" 
value="<?php echo $this->_tpl_vars['fields']['tog_company_contactstog_company_ida']['value']; ?>
">
<span class="id-ff multiple">
<button type="button" name="btn_<?php echo $this->_tpl_vars['fields']['tog_company_contacts_name']['name']; ?>
" id="btn_<?php echo $this->_tpl_vars['fields']['tog_company_contacts_name']['name']; ?>
" tabindex="0" title="<?php echo smarty_function_sugar_translate(array('label' => 'LBL_SELECT_BUTTON_TITLE'), $this);?>
" class="button firstChild" value="<?php echo smarty_function_sugar_translate(array('label' => 'LBL_SELECT_BUTTON_LABEL'), $this);?>
"
onclick='open_popup(
"<?php echo $this->_tpl_vars['fields']['tog_company_contacts_name']['module']; ?>
", 
600, 
400, 
"", 
true, 
false, 
<?php echo '{"call_back_function":"set_return","form_name":"EditView","field_to_name_array":{"id":"tog_company_contactstog_company_ida","name":"tog_company_contacts_name"}}'; ?>
, 
"single", 
true
);' ><img src="<?php echo smarty_function_sugar_getimagepath(array('file' => "id-ff-select.png"), $this);?>
"></button><button type="button" name="btn_clr_<?php echo $this->_tpl_vars['fields']['tog_company_contacts_name']['name']; ?>
" id="btn_clr_<?php echo $this->_tpl_vars['fields']['tog_company_contacts_name']['name']; ?>
" tabindex="0" title="<?php echo smarty_function_sugar_translate(array('label' => 'LBL_ACCESSKEY_CLEAR_RELATE_TITLE'), $this);?>
"  class="button lastChild"
onclick="SUGAR.clearRelateField(this.form, '<?php echo $this->_tpl_vars['fields']['tog_company_contacts_name']['name']; ?>
', '<?php echo $this->_tpl_vars['fields']['tog_company_contacts_name']['id_name']; ?>
...
SUGAR.util.doWhen(
		"typeof(sqs_objects) != 'undefined' && typeof(sqs_objects['<?php echo $this->_tpl_vars['form_name']; ?>
_<?php echo $this->_tpl_vars['fields']['tog_company_contacts_name']['name']; ?>
']) != 'undefined'",
		enableQS
);
</script>
...
addToValidate(\'EditView\', \'tog_company_contacts_name\', \'relate\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_TOG_COMPANY_CONTACTS_FROM_TOG_COMPANY_TITLE','module' => 'Contacts','for_js' => true), $this); echo '\' );
