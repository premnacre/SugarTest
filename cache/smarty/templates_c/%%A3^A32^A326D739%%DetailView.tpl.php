<?php /* Smarty version 2.6.11, created on 2016-05-20 05:17:25
...
<td width='12.5%' scope="col">
<?php if (! $this->_tpl_vars['fields']['tog_company_contacts_name']['hidden']):  ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_TOG_COMPANY_CONTACTS_FROM_TOG_COMPANY_TITLE','module' => 'Contacts'), $this); $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean();  echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
<?php endif; ?>
</td>
<td width='37.5%'  >
<?php if (! $this->_tpl_vars['fields']['tog_company_contacts_name']['hidden']):  echo smarty_function_counter(array('name' => 'panelFieldCount'), $this);?>


<?php if (! empty ( $this->_tpl_vars['fields']['tog_company_contactstog_company_ida']['value'] )):  ob_start(); ?>index.php?module=tog_Company&action=DetailView&record=<?php echo $this->_tpl_vars['fields']['tog_company_contactstog_company_ida']['value'];  $this->_smarty_vars['capture']['default'] = ob_get_contents();  $this->assign('detail_url', ob_get_contents());ob_end_clean(); ?>
<a href="<?php echo smarty_function_sugar_ajax_url(array('url' => $this->_tpl_vars['detail_url']), $this);?>
"><?php endif; ?>
<span id="tog_company_contactstog_company_ida" class="sugar_field" data-id-value="<?php echo $this->_tpl_vars['fields']['tog_company_contactstog_company_ida']['value']; ?>
"><?php echo $this->_tpl_vars['fields']['tog_company_contacts_name']['value']; ?>
</span>
<?php if (! empty ( $this->_tpl_vars['fields']['tog_company_contactstog_company_ida']['value'] )): ?></a><?php endif;  endif; ?>
</td>
</tr>
<?php $this->_smarty_vars['capture']['tr'] = ob_get_contents();  $this->assign('tableRow', ob_get_contents());ob_end_clean();  if ($this->_tpl_vars['fieldsUsed'] > 0 && $this->_tpl_vars['fieldsUsed'] != $this->_tpl_vars['fieldsHidden']):  echo $this->_tpl_vars['tableRow']; ?>
