<?php 
 $GLOBALS["dictionary"]["tog_Company"]=array (
  'table' => 'tog_company',
  'audited' => true,
  ...
  array (
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'tog_company_created_by',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'tog_company_modified_user',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'tog_company_assigned_user',
    ...
    'tog_company_type' => 
    array (
      'name' => 'tog_company_type',
      'vname' => 'LBL_TYPE',
      'type' => 'enum',
      'options' => 'tog_company_type_dom',
      'len' => 50,
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'tog_company_email_addresses_primary',
      'source' => 'non-db',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'tog_company_email_addresses',
      'source' => 'non-db',
    ...
    'tog_testmodule_tog_company_name' => 
    array (
    ...
    'tog_testmodule_tog_companytog_testmodule_ida' => 
    array (
