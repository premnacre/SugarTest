...
{capture name="label" assign="label"}{sugar_translate label='LBL_TOG_COMPANY_CONTACTS_FROM_TOG_COMPANY_TITLE' module='Contacts'}{/capture}
{$label|strip_semicolon}:
</td>
{counter name="fieldsUsed"}
...
<input type="text" name="{$fields.tog_company_contacts_name.name}" class="sqsEnabled" tabindex="0" id="{$fields.tog_company_contacts_name.name}" size="" value="{$fields.tog_company_contacts_name.value}" title='' autocomplete="off"  	 >
<input type="hidden" name="{$fields.tog_company_contacts_name.id_name}" 
id="{$fields.tog_company_contacts_name.id_name}" 
value="{$fields.tog_company_contactstog_company_ida.value}">
<span class="id-ff multiple">
<button type="button" name="btn_{$fields.tog_company_contacts_name.name}" id="btn_{$fields.tog_company_contacts_name.name}" tabindex="0" title="{sugar_translate label="LBL_SELECT_BUTTON_TITLE"}" class="button firstChild" value="{sugar_translate label="LBL_SELECT_BUTTON_LABEL"}"
onclick='open_popup(
"{$fields.tog_company_contacts_name.module}", 
600, 
400, 
"", 
true, 
false, 
{literal}{"call_back_function":"set_return","form_name":"EditView","field_to_name_array":{"id":"tog_company_contactstog_company_ida","name":"tog_company_contacts_name"}}{/literal}, 
"single", 
true
);' ><img src="{sugar_getimagepath file="id-ff-select.png"}"></button><button type="button" name="btn_clr_{$fields.tog_company_contacts_name.name}" id="btn_clr_{$fields.tog_company_contacts_name.name}" tabindex="0" title="{sugar_translate label="LBL_ACCESSKEY_CLEAR_RELATE_TITLE"}"  class="button lastChild"
onclick="SUGAR.clearRelateField(this.form, '{$fields.tog_company_contacts_name.name}', '{$fields.tog_company_contacts_name.id_name}');"  value="{sugar_translate label="LBL_ACCESSKEY_CLEAR_RELATE_LABEL"}" ><img src="{sugar_getimagepath file="id-ff-clear.png"}"></button>
</span>
<script type="text/javascript">
SUGAR.util.doWhen(
		"typeof(sqs_objects) != 'undefined' && typeof(sqs_objects['{$form_name}_{$fields.tog_company_contacts_name.name}']) != 'undefined'",
		enableQS
);
</script>
</tr>
...
addToValidate('EditView', 'tog_company_contacts_name', 'relate', false,'{/literal}{sugar_translate label='LBL_TOG_COMPANY_CONTACTS_FROM_TOG_COMPANY_TITLE' module='Contacts' for_js=true}{literal}' );
...
addToValidateBinaryDependency('EditView', 'tog_company_contacts_name', 'alpha', false,'{/literal}{sugar_translate label='ERR_SQS_NO_MATCH_FIELD' module='Contacts' for_js=true}{literal}: {/literal}{sugar_translate label='LBL_TOG_COMPANY_CONTACTS_FROM_TOG_COMPANY_TITLE' module='Contacts' for_js=true}{literal}', 'tog_company_contactstog_company_ida' );
